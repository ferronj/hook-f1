...
QUALIFYING_RESULTS = {
    ...
    6: [  # Monaco Grand Prix
        ...
        ("Lewis Hamilton", "Ferrari", 3),
        ("Charles Leclerc", "Ferrari", 4),
        ("Isack Hadjar", "Red Bull Racing", 5),
        ...
        ("Nico Hulkenberg", "Audi", 13),
        ("Franco Colapinto", "Alpine", 14),
        ("Arvid Lindblad", "Racing Bulls", 15),
        ("Gabriel Bortoleto", "Audi", 16),
        ("Esteban Ocon", "Haas F1 Team", 17),
        ("Sergio Perez", "Cadillac", 18),
        ("Oliver Bearman", "Haas F1 Team", 19),
        ("Valtteri Bottas", "Cadillac", 20),
        ("Fernando Alonso", "Aston Martin", 21),
        ("Lance Stroll", "Aston Martin", 22),
    ],
...
RACE_RESULTS = {
    ...
    6: [  # Monaco Grand Prix (actual results; Gasly's pre-race penalties overturned in right-of-review)
        ("Kimi Antonelli", "Mercedes", 1, "1", 78, "2:23:31.243", 25, 1),
        ("Lewis Hamilton", "Ferrari", 2, "2", 78, "+6.271", 18, 1),
        ("Pierre Gasly", "Alpine", 3, "3", 78, "+20.369", 15, 1),
        ("Isack Hadjar", "Red Bull Racing", 4, "4", 78, "+23.394", 12, 1),
        ("Oscar Piastri", "McLaren", 5, "5", 78, "+24.261", 10, 1),
        ("Liam Lawson", "Racing Bulls", 6, "6", 78, "+26.553", 8, 1),
        ("Arvid Lindblad", "Racing Bulls", 7, "7", 78, "+29.010", 6, 1),
        ("Alexander Albon", "Williams", 8, "8", 78, "+33.413", 4, 1),
        ("Esteban Ocon", "Haas F1 Team", 9, "9", 78, "+37.140", 2, 1),
        ("Fernando Alonso", "Aston Martin", 10, "10", 78, "+41.899", 1, 1),
        ("Gabriel Bortoleto", "Audi", 11, "11", 78, "+42.748", 0, 1),
        ("George Russell", "Mercedes", 12, "12", 78, "+43.353", 0, 1),
        ("Nico Hulkenberg", "Audi", 13, "13", 78, "+44.102", 0, 1),
        ("Franco Colapinto", "Alpine", 14, "14", 78, "+48.964", 0, 1),
        ("Sergio Perez", "Cadillac", 15, "15", 78, "+49.153", 0, 1),
        ("Carlos Sainz", "Williams", 16, "16", 70, "+8 Laps", 0, 1),
        ("Charles Leclerc", "Ferrari", 17, "R", 64, "\\N", 0, 130),
        ("Lance Stroll", "Aston Martin", 18, "R", 56, "\\N", 0, 130),
        ("Lando Norris", "McLaren", 19, "R", 43, "\\N", 0, 130),
