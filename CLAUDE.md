...
- **Features**: Model selector (Stage 6/Composite/Stage 9), podium prediction, full grid table, position distributions, model comparison, constructor analysis, position heatmap
