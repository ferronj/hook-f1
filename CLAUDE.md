...
- **Features**: Model selector (Stage 6/Composite/Stage 9), podium prediction, full grid table, position distributions, model comparison, constructor analysis, position heatmap. Optional **Agent Forecast** section renders only when `agent_prediction` is present in the sim JSON — gracefully omitted otherwise.
